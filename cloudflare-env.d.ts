/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 4d4bf3a6e3b7f5c9982fe5722e01486e)
// Runtime types generated with workerd@1.20260702.1 2026-07-09 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	UPLOAD_INIT_LIMIT: RateLimit;
	UPLOAD_COMPLETE_LIMIT: RateLimit;
	DOWNLOAD_LIMIT: RateLimit;
	DOWNLOAD_LOOKUP_LIMIT: RateLimit;
	TUNNEL_CREATE_LIMIT: RateLimit;
	TUNNEL_JOIN_LIMIT: RateLimit;
	ADMIN_LOGIN_LIMIT: RateLimit;
	ASSETS: Fetcher;
	...
	TUNNEL: DurableObjectNamespace /* TunnelRoom */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./build/worker");
		durableNamespaces: "TunnelRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "S3_ENDPOINT" | "S3_REGION" | "S3_BUCKET" | "MAX_FILE_SIZE" | "MAX_FILE_SIZE_ADMIN" | "MIN_SHARE_TTL" | "MAX_SHARE_TTL" | "MAX_DAILY_BYTES_PER_IP" | "MAX_DAILY_COUNT_PER_IP" | "MAX_TOTAL_BYTES" | "MAX_TOTAL_COUNT" | "UPLOAD_URL_TTL" | "PROXY_MAX_FILE_SIZE" | "ADMIN_JWT_TTL_SECONDS" | "CLEANUP_BATCH_SIZE" | "CLEANUP_MAX_BATCH_MS" | "CLEANUP_QUOTA_KEEP_DAYS" | "CLEANUP_AUDIT_KEEP_DAYS" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "CRON_SECRET" | "ADMIN_PASSWORD" | "ADMIN_JWT_SECRET">> {}
}
