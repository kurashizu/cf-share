...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "S3_ENDPOINT" | "S3_REGION" | "S3_BUCKET" | "MAX_FILE_SIZE" | "MAX_FILE_SIZE_ADMIN" | "MIN_SHARE_TTL" | "MAX_SHARE_TTL" | "MAX_DAILY_BYTES_PER_IP" | "MAX_DAILY_COUNT_PER_IP" | "MAX_TOTAL_BYTES" | "UPLOAD_URL_TTL" | "PROXY_MAX_FILE_SIZE" | "ADMIN_JWT_TTL_SECONDS" | "CLEANUP_BATCH_SIZE" | "CLEANUP_MAX_BATCH_MS" | "CLEANUP_QUOTA_KEEP_DAYS" | "CLEANUP_AUDIT_KEEP_DAYS" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "CRON_SECRET" | "ADMIN_PASSWORD" | "ADMIN_JWT_SECRET">> {}
}
